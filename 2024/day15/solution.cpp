...
bool can_move_big_object(Map& map, Position position, Direction direction)
{
    ...
    else if (is_box(object))
    {
        if (direction == Direction::up || direction == Direction::down)
        {
            ...
            Position new_position_2 = (object == BOX_LEFT) ? move(new_position_1, Direction::right)
            ...
            if (object_at_new_position_1 == EMPTY && object_at_new_position_2 == EMPTY)
            {
                return true;
            }
    ...
    else if (is_box(object))
    {
        if (direction == Direction::up || direction == Direction::down)
        {
            ...
            if (object_at_new_position_1 == EMPTY && object_at_new_position_2 == EMPTY)
            {
                ...
                object_at_new_position_2 = (object == BOX_LEFT) ? BOX_RIGHT : BOX_LEFT;
            ...
            else if (object == object_at_new_position_1)
            {
                ...
                can_move_big_object(map, new_position_1, direction) &&
                can_move_big_object(map, new_position_2, direction))
            {
